...
export default function EmailCapture({ onSubmit, onPrint, isOpen, onClose }: EmailCaptureProps) {
        ...
        <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full p-8 md:p-12 relative">
          ...
          <div className="text-center">
            ...
            <h2 className="text-3xl font-bold text-primary-purple mb-3">
              Your Dream Life Plan is Ready!
            </h2>
            <p className="text-lg text-navy mb-6">
              Print it, save it, and start making it happen.
            </p>
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full p-8 md:p-12 relative">
        ...
        <div className="text-center mb-6">
          <h2 className="text-3xl md:text-4xl font-bold text-primary-purple mb-3">
            Get Your Dream Life Plan
          </h2>
          <p className="text-lg text-navy">
            See exactly what income you need — broken down to the hour.
          </p>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-light-blush">
          ...
          <ul className="space-y-2 text-sm text-navy/80">
            <li className="flex items-start">
              ...
              <span>Your complete dream life cost breakdown (print or save as PDF)</span>
            </li>
            <li className="flex items-start">
              <span className="text-primary-purple mr-2">✓</span>
              <span>Income needed: annual, monthly, weekly, daily, and hourly</span>
            </li>
          </ul>
        </div>
      </div>
