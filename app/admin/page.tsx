...
// Dynamically import Clerk components to avoid build errors when keys aren't set
...
export default function AdminDashboard() {
  ...
  if (isChecking) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-light-blush">
        <div className="text-2xl text-primary-purple">Loading...</div>
      </div>
    )
  }

  // If Clerk isn't configured, show setup message
      ...
      <div className="min-h-screen flex items-center justify-center bg-light-blush">
        <div className="bg-white rounded-2xl shadow-lg p-8 max-w-md w-full text-center">
          ...
          <p className="text-navy mb-6">
            Authentication is not configured yet. Add your Clerk keys to Vercel to enable secure admin access.
          </p>
          <div className="text-left bg-light-blush p-4 rounded-lg text-sm mb-4">
            <p className="font-semibold mb-2">Required environment variables:</p>
            <code className="block text-xs mb-1">NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY</code>
        ...
        <div className="min-h-screen flex items-center justify-center bg-light-blush">
          <div className="bg-white rounded-2xl shadow-lg p-8 max-w-md w-full text-center">
            ...
            <SignInButton mode="modal">
              <button className="px-6 py-3 bg-primary-purple text-white rounded-lg hover:bg-light-lavender transition-colors font-semibold">
                Sign In
              </button>
            </SignInButton>
          </div>
